            ...
            <div class="my-5 d-flex flex-md-row flex-column justify-content-md-between">
                <div class="kiri bg-white d-flex p-5 mx-1 flex-lg-row flex-column ">
                    ...
                    <div class="d-flex flex-column justify-content-center  mx-auto mx-lg-0">
                        ...
                        <a href="/visi&misi" class="titillium mx-auto w-100 text-decoration-none text-white d-flex justify-content-center align-items-center">GO</a>
                    </div>
                </div>
                <div class="kanan bg-white d-flex p-5 mx-1 flex-lg-row flex-column my-5 my-md-0">
                    ...
                    <div class="d-flex flex-column justify-content-center mx-auto mx-lg-0">
                        ...
                        <a href="/aboutus" class="titillium mx-auto w-100 text-decoration-none row-2 text-white d-flex justify-content-center align-items-center">GO</a>
                    </div>
                </div>
            </div>
            <div class="bawah bg-white d-flex flex-lg-row flex-column p-5">
                ...
                <div class="mx-lg-4 mx-auto ">
                    ...
                    <div class="d-flex flex-lg-row flex-column justify-content-lg-between">
                        ...
                        <a href="/service" class="titillium isi-service mx-auto mx-lg-0 text-decoration-none d-flex justify-content-center align-items-center text-white">GO</a>
                    </div>
                </div>
            </div>
        </div>
