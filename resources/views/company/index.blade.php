...
@section('title','PT. INDOTRANS JAYAMAS ABADI')
@section('style')
<style>
        ...
        <div class="home_after_more">
            <div class="home_after_more_card">
                ...
                <div style="padding-top:50px;padding-bottom:50px;">
                    ...
                    <button class="button_more"><a href="/visi&misi"style="text-decoration: none; color: white; margin-top: auto;margin-bottom:auto;">GO</a></button>
                </div>
            </div>
            <div class="home_after_more_card">
                ...
                <div style="padding-top:50px;padding-bottom:50px;">
                    <p>About<br>US</p>
                    <button class="button_more"><a href="/aboutus" style="text-decoration: none; color: white; margin-bottom:auto;">CHECK</a></button>
                </div>
            </div>
            <div class="home_after_more_services"  style="grid-column:span 2;gap:50px;">
                ...
                <div style="padding-top:50px;padding-bottom:50px;">
                    ...
                    <div style="display:flex; gap:3rem;" class="service_button">
                        <p style="font-size:28px;" class="silahkan_pesan">Silahkan Lakukan Pemesanan</p><button class="button_more"><a href="/service" style="text-decoration: none; color: white; margin-bottom:auto;">GO</a></button>
                    </div>
