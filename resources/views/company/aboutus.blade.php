            ...
            <div id="company" class="my-5 bg-white p-lg-5 pt-0 pt-lg-5 pb-2 px-4 rounded-5 shadow shadow-top-0">
                <div id="upperCompany" class="d-flex flex-column my-0 my-lg-5">
                    ...
                    <div class="d-flex flex-column flex-lg-row">
                        <p class="isi-konten col col-12 col-lg-6 kanit me-3" >PT. JAYAMAS ABADI started operating in 1999.
        ...
        <div class="container">
            ...
            <div id="company" class="my-5 bg-white p-lg-5 pt-0 pt-lg-5 pb-2 px-4 rounded-5 shadow shadow-top-0">
                <div id="upperCompany" class="d-flex flex-column my-0 my-lg-5">
                    ...
                    <div class="d-flex flex-column flex-lg-row">
                        <p class="isi-konten col col-12 col-lg-6 kanit me-3" >PT. INDOTRANS JAYAMAS ABADI mulai beroperasi pada tahun 1999.
                ...
                <p class="isi-konten kanit">Saat ini, PT INDOTRANS JAYAMAS ABADI berkembang dengan membuka usaha baru
                    ...
                    yakin bahwa kami akan dapat memberikan kepuasan layanan kepada
                    pelanggan kami dan mewujudkan MISI dan VISI PERUSAHAAN
                    dengan tepat.
                </p>
            </div>
            <div class="my-xl-5 my-lg-4 my-md-3 my-sm-2 my-1 py-xl-5 py-lg-4 py-md-3 py-sm-2 py-">
            ...
            <div class="bg-white rounded-5 p-lg-3 d-flex flex-column my-5 justify-content-end">
                ...
                <div class="mx-5">
                    <ol>
                        ...
                        <ol style="list-style:lower-latin">
                            <li class="isi-konten kanit">FCL --> Kami menyediakan layanan kargo Export / Import untuk Full Container (20 feet / 40 feet / 40'HC / Refeer)</li>
                            <li class="isi-konten kanit">LCL --> Kami juga menyediakan LCL ekspor/Impor ke atau dari berbagai tujuan.</li>
                        </ol>
                        <li class="isi-konten kanit">Indotrans Jayamas Abadi menyediakan jasa custom baik untuk laut maupun udara maupun untuk keperluan import atau ekspor.</li>
