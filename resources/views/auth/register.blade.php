...
@section('isi')
    <div class="mt-5 mb-5">
        <div class="d-flex justify-content-center">
            <img src="{{ asset('app/assets/image/profile.png') }}" class="logo-register" />
            <p class="main-text-register align-items-center my-auto ms-5">REGISTER</p>
        </div>
    </div>
    <div class="box mx-auto mb-5">
        <div class="d-flex mb-4" style="background-color: #4D65AE; border-radius: 20px 20px 10px 10px; padding: 10px;">
            <h3 class="perintah my-auto" style="color: white; font-family: 'Titillium Web', sans-serif;">Required field is indicated by<h3><p class="perintah my-auto" style="color: red;">*</p>
        </div>
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <div class="d-flex ms-3">
                ...
                <h1 class="sub-judul my-auto"><b>Company Information</b></h1></ol>
            </div>
            <hr />
            ...
            <div class="mt-4">
               <x-input-label for="company" :value="__('Company')" class="label" style="width: 160px;" />
                <x-text-input id="company" class="block mt-1 w-full input" type="text" name="company" :value="old('company')" required class="input" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="emailcompany" class="block mt-1 w-full input" type="email" name="emailcompany" :value="old('emailcompany')" required class="input" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="notelp" class="block mt-1 w-full input" type="text" name="notelp" :value="old('notelp')" required class="input" />
            ...
            <div class="mt-4 mb-5">
                ...
                <x-text-input id="nib" class="block mt-1 w-full input" type="text" name="nib" :value="old('nib')" required class="input" />
            ...
            <div class="d-flex mt-5 ms-3">
                <div class="my-auto me-3" style="background-color: black; width: 10px; height: 10px;"></div>
                <h1 class="sub-judul my-auto"><b>User Information</b></h1></ol>
            </div>
            <hr />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="username" class="block mt-1 w-full input" type="text" name="username" :value="old('username')" required autofocus class="input" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="firstname" class="block mt-1 w-full input" type="text" name="firstname" :value="old('firstname')" required autofocus class="input" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="lastname" class="block mt-1 w-full input" type="text" name="lastname" :value="old('lastname')" required autofocus class="input" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="email" class="block mt-1 w-full input" type="email" name="email" :value="old('email')" required class="input" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="npwp" class="block mt-1 w-full input" type="text" name="npwp" :value="old('npwp')" required class="input" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="photo" class="block mt-1 w-full" type="file" name="photo" :value="old('photo')" class="input" />
