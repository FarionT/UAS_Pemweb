...
<x-app-layout>
            ...
            <div class="iniform">
                    ...
                    <div class="kotakprofil d-flex flex-row mx-auto">
                        ...
                        <div class="biodataSingkat my-auto mx-auto form-group col-lg-8">
                            ...
                            <div>
                                ...
                                <x-text-input id="npwp" name="npwp" type="text" class="mt-1 block w-full" :value="old('npwp', $user->npwp)" required autofocus autocomplete="npwp" />
                        ...
                        <div class="userprofil" style="height: 300px;">
                            <div class="biodataSingkat pt-3 ps-4 form-group form-control-lg">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="emailcompany" name="emailcompany" type="email" class="mt-1 block w-full" :value="old('emailcompany', $user->emailcompany)" required autocomplete="emailcompany" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="nib" name="nib" type="text" class="mt-1 block w-full" :value="old('nib', $user->nib)" required autofocus autocomplete="nib" />
                ...
                <div class="d-flex justify-content-center">
                    <div class="flex items-center gap-4">
                        <x-primary-button class="btn p-auto d-flex justify-content-center" style="font-family: 'Titillium Web', sans-serif; background-color: #011D83; font-size: 22px; width:129.56px;height:51px;">{{ __('Save') }}</x-primary-button>
                        ...
                        @if (session('status') === 'profile-updated')
                            <p
                                ...
                                class="text-sm text-gray-600 my-auto mx-auto"
                    ...
                    @auth
                        @if (Auth::user()->role_id == 1)
                            <a href="/admin/account" class="btn btn-primary ms-5" style="font-family: 'Titillium Web', sans-serif; font-weight: bold; background-color: #011D83; font-size: 22px; padding: 8px 24px;">Confirm Account</a>
                            <a href="/orders" class="btn btn-primary ms-5" style="font-family: 'Titillium Web', sans-serif; font-weight: bold; background-color: #011D83; font-size: 22px; padding: 8px 24px;">View All Order</a>
                        @endif
                    @endauth
                </div>
            </div>
    ...
    <div class="subjudul d-flex">
        <p class="mx-auto my-auto" style="font-size: 30px; color:white;">Password</p>
    </div>
    <div class="profilebox mx-auto">
        <form method="post" action="{{ route('password.update') }}" class="mx-auto">
            ...
            <div class="iniform">
                <div class="">
                    <div class="mt-5">
                        <div id="pembatas1" class="d-flex justify-content-center">
                            <p id="pembatas" class="align-items-center my-auto"><span>Update Password</span></p>
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-center">
                ...
                <x-primary-button class="btn p-auto d-flex justify-content-center me-5" style="font-family: 'Titillium Web', sans-serif; background-color: #011D83; font-size: 22px; width:129.56px;height:51px;">{{ __('Save') }}</x-primary-button>
                    @if (session('status') === 'password-updated')
                        <p
                            ...
                            x-transition
                            x-init="setTimeout(() => show = false, 2000)"
                            class="text-sm text-gray-600 my-auto ms-3"
                            style="font-size: 25px;"
                        >{{ __('Saved.') }}</p>
                    @endif
            </div>
    ...
    <div class="subjudul d-flex">
        <p class="mx-auto my-auto" style="font-size: 30px; color:white;">Account</p>
    </div>
    <div class="profilebox mx-auto">
        <div class="iniform">
            <header>
            ...
            <div class="d-flex">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <a href="route('logout')"
                        ...
                        style="font-family: 'Titillium Web', sans-serif; font-weight: bold; background-color: #011D83; font-size: 22px; padding: 8px 24px;">
                        {{ __('Log Out') }}
                    </a>
                </form>
            </div>
